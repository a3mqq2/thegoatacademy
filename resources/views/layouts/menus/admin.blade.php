  ...
  <li class="pc-item">
    ...
    <li class="pc-item pc-hasmenu">
      ...
      <ul class="pc-submenu" style="display: none;">
        ...
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link">
            <span class="pc-mtext"> Levels </span>
            <span class="pc-arrow">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                   viewBox="0 0 24 24" fill="none" stroke="currentColor"
                   stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          ...
          <ul class="pc-submenu" style="display: none;">
            <li class="pc-item">
              <a class="pc-link" href="{{ route('admin.levels.create') }}">Create New Level</a>
            </li>
            <li class="pc-item">
              <a class="pc-link" href="{{ route('admin.levels.index') }}">Show All Levels</a>
            </li>
          </ul>
        </li>
        ...
        <li class="pc-item pc-hasmenu">
          <a href="#!" class="pc-link">
            <span class="pc-mtext"> Meeting Platforms </span>
            <span class="pc-arrow">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                   viewBox="0 0 24 24" fill="none" stroke="currentColor"
                   stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
          ...
          <ul class="pc-submenu" style="display: none;">
            <li class="pc-item">
              <a class="pc-link" href="{{ route('admin.meeting_platforms.create') }}">Create New Meeting Platform</a>
            </li>
            <li class="pc-item">
              <a class="pc-link" href="{{ route('admin.meeting_platforms.index') }}">Show All Meeting Platforms</a>
            </li>
          </ul>
        </li>
