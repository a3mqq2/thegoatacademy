...
<body>
  ...
  <div class="container">
    ...
    <div class="arabic-text">
      ...
      <ul>
        <li>يُرجى الالتزام بالحضور، ومن يتغيب عن ست محاضرات سيتم استبعاده بدون إرجاع المبلغ.</li>
        <li>يُرجى الالتزام بتوقيت الكورس وعدم التأخر عن موعد المحاضرات.</li>
        <li>يُرجى العلم أن موعد الاختبار النصفي والنهائي ثابت ولا يتغير.</li>
        <li>المبلغ غير قابل للاسترجاع في حالة الانسحاب بعد المحاضرة التعريفية.</li>
        <li>تُعطى الشهادة فقط لمن يجتاز بنسبة 80% أو أكثر.</li>
        <li>جميع المحاضرات تُقام مباشرةً (لايف) ولا يوجد تسجيل.</li>
      </ul>
    </div>
