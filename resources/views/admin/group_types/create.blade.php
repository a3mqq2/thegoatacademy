...
@section('title', 'Create Group Type')
...
@section('breadcrumb')
  ...
  <li class="breadcrumb-item active">
    <i class="fa fa-plus"></i> Create Group Type
  </li>
@endsection
...
<div class="container">
  <div class="card mt-3">
    <div class="card-header">
      <h4><i class="fa fa-plus"></i> Create Group Type</h4>
    </div>
    <div class="card-body">
      <form action="{{ route('admin.group-types.store') }}" method="POST">
        @csrf
        <div class="row g-3">
          <div class="col-md-6">
            <label for="name" class="form-label"><i class="fa fa-tag"></i> Name</label>
            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Enter group type name">
            @error('name')
        ...
        <div class="mt-4 d-flex justify-content-end">
          ...
          <button type="submit" class="btn btn-primary">
            <i class="fa fa-save"></i> Save Group Type
          </button>
        </div>
      </form>
    </div>
