...
@section('breadcrumb')
  ...
  <li class="breadcrumb-item active">
    <i class="fa fa-plus"></i> Create Level
  </li>
@endsection
...
<div class="container">
  <div class="card mt-3">
    <div class="card-header">
      <h4><i class="fa fa-plus"></i> Create Level</h4>
    </div>
    <div class="card-body">
      <form action="{{ route('admin.levels.store') }}" method="POST">
        ...
        <div class="row g-3">
          <div class="col-md-12">
            ...
            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Enter level name" required>
            @error('name')
