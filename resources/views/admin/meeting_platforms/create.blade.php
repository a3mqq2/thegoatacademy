...
@section('title', 'Create Meeting Platform')
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">
        <i class="fa fa-plus"></i> Create Platform
    </li>
@endsection
...
<div class="container">
    <div class="card mt-3">
        <div class="card-header">
            <h4><i class="fa fa-plus"></i> Create Meeting Platform</h4>
        </div>
        <div class="card-body">
            ...
            {{-- Form start --}}
            <form action="{{ route('admin.meeting_platforms.store') }}" method="POST">
                @csrf
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-save"></i> Save Platform
                    </button>
                </div>
            </form>
        </div>
