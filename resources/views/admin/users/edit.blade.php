    ...
    <div class="col-md-10">
      <div class="card shadow">
        <div class="card-header bg-light text-primary">
          <h5 class="mb-0 text-primary"><i class="fa fa-user-edit"></i> Edit User #{{ $user->id }}</h5>
        </div>
        ...
        <div class="card-body">
          <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="mb-3">
                  <label for="password" class="form-label"><i class="fa fa-lock"></i> Password (leave blank if unchanged):</label>
                  <input 
                    type="password" 
                    name="password" 
                    id="password" 
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <input 
                    ...
                    class="form-control"
                  >
                  <small class="text-muted">Re-enter password if changing.</small>
                </div>
              </div>
            </div> <!-- end row -->
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="mb-3 border p-3 rounded bg-light">
                  @foreach($roles as $role)
                    <div class="permissions-group" data-role-id="{{ $role->id }}" style="display: none;">
